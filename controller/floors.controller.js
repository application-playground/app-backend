const floors = require('../model/floors.model');
...
module.exports = {
    ...
    list: function (req, res, next) {
        ...
        // Find some documents
        // floors.countDocuments();
        floors.countDocuments(search, function (err, totalCount) {
            if (err) {
                response = { "error": true, "message": "Error fetching data" }
            }
            floors.find(search, {}, query, function (err, data) {
    ...
    //     floors.find({}, { 'name': 1, 'email': 1, '_id': 0 }, function (err, data) {
    //         if (err) {
    //             response = { "error": true, "message": "Error fetching data" };
    //         } else {
