const blockMaster = require('./../model/bloclMaster.model');
...
module.exports = {
    ...
    list: function (req, res, next) {
        ...
        // Find some documents
        blockMaster.countDocuments(search, function (err, totalCount) {
            if (err) {
                response = { "error": true, "message": "Error fetching data" }
            }
            blockMaster.find(search, {}, query, function (err, data) {
    ...
    exportCSV: function (req, res, next) {
        blockMaster.find({}, { 'name': 1, 'email': 1, '_id': 0 }, function (err, data) {
            if (err) {
                response = { "error": true, "message": "Error fetching data" };
            } else {
